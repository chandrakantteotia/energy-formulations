...
import { Phone, Mail, MapPin, Clock, ArrowRight, CheckCircle, Sparkles, Send, Check } from 'lucide-react';
...
export default function ContactExperience({ prefillData }) {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-brand-navy-950 text-white relative overflow-hidden border-t border-brand-navy-800">
      {/* Background Ambience */}
      <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-brand-blue-700/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-green-500/15 border border-brand-green-500/30 text-brand-green-400 text-xs font-bold uppercase tracking-widest mb-6">
                <Sparkles className="w-3.5 h-3.5" />
                <span>Start a Partnership</span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tightest text-white leading-[1.15] mb-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl bg-brand-navy-900 border border-brand-navy-750 text-brand-green-400 flex items-center justify-center shrink-0">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs uppercase font-bold tracking-wider text-slate-400">Direct Inquiries</div>
                    <a href={`tel:${BRAND_CONFIG.contact.phone}`} className="text-base font-bold text-white hover:text-brand-green-400 transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs uppercase font-bold tracking-wider text-slate-400">Business Development</div>
                    <a href={`mailto:${BRAND_CONFIG.contact.email}`} className="text-base font-bold text-white hover:text-brand-green-400 transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs uppercase font-bold tracking-wider text-slate-400">Facility Location</div>
            ...
            {/* Turnaround Badge */}
            <div className="mt-10 p-5 rounded-2xl bg-brand-navy-900/90 border border-brand-navy-750 flex items-center gap-3">
              <Clock className="w-5 h-5 text-brand-green-400 shrink-0" />
          ...
          <div className="lg:col-span-7">
            <div className="bg-brand-navy-900 rounded-3xl border border-brand-navy-700/80 p-6 sm:p-10 shadow-2xl relative">
              
              {isSubmitted ? (
                /* Celebration / Success Animation State */
                <div className="py-12 sm:py-16 text-center space-y-6 animate-fade-in">
                  <div className="w-20 h-20 rounded-full bg-brand-green-500/20 border-2 border-brand-green-500 text-brand-green-400 flex items-center justify-center mx-auto shadow-glow-green">
                  ...
                  <div className="p-4 rounded-xl bg-brand-navy-950 border border-brand-navy-800 text-left max-w-md mx-auto text-xs text-slate-300 space-y-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-navy-800 hover:bg-brand-navy-700 text-xs font-bold uppercase tracking-wider text-white transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="pb-3 border-b border-brand-navy-800">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-brand-navy-950 border text-sm text-white focus:outline-none focus:ring-2 transition-all ${
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      {errors.businessEmail && <p className="text-[11px] text-red-400 mt-1">{errors.businessEmail}</p>}
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-3 py-2.5 rounded-lg bg-brand-navy-950 border border-brand-navy-750 text-xs font-semibold text-white focus:outline-none focus:border-brand-green-500"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-brand-navy-950 border border-brand-navy-750 text-sm text-white focus:outline-none focus:border-brand-green-500 focus:ring-2 focus:ring-brand-green-500/30"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-brand-navy-950 border border-brand-navy-750 text-sm text-white focus:outline-none focus:border-brand-green-500 focus:ring-2 focus:ring-brand-green-500/30 resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 px-6 rounded-xl text-sm font-bold uppercase tracking-wider text-brand-navy-950 bg-brand-green-500 hover:bg-brand-green-400 shadow-glow-green transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-70 group"
                  >
                    {isSubmitting ? (
